  ...
  <Layout>
    <div className="container mx-auto px-4 py-16 max-w-3xl">
      ...
      <div className="prose prose-sm text-muted-foreground space-y-4">
        <p>The information and content provided by Fliki is for general entertainment purposes only.</p>
        <h2 className="text-xl font-display font-semibold text-foreground mt-8">No Hosting</h2>
        <p>Fliki does not host, store, or distribute any video content. All streams are sourced from publicly available M3U playlists found on the internet. We act solely as an aggregator.</p>
        ...
        <p>If you believe that any content accessible through Fliki infringes your copyright, please contact us immediately and we will take appropriate action.</p>
        <h2 className="text-xl font-display font-semibold text-foreground mt-8">Liability</h2>
        <p>Fliki shall not be held liable for any damages arising from the use of this service. Users access streams at their own risk.</p>
      </div>
    </div>
  </Layout>
);
